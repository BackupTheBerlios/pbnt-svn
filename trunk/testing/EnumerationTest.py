...
def test():
  ...
  if myFloatEQ(Q.CPT[False], .0550):
    print "Test 2A: OK\n"
  else:
    test2 = 0
    print "Test 2A: FAILED\n"
  
  if myFloatEQ(Q.CPT[True], .9450):
    print "Test 2B: OK\n"
  else:
    test2 = 0
  ...
  test3 = 1
  if myFloatEQ(Q.CPT[False], .5):
    print "Test 3A: OK\n"
  else:
    test3 = 0
    print "Test 3A: FAILED\n"
  
  if myFloatEQ(Q.CPT[True], .5):
    print "Test 3B: OK\n"
  else:
    test3 = 0
  ...
  test4 = 1
  if myFloatEQ(Q.CPT[False], .1220):
    print "Test 4A: OK\n"
  else:
    test4 = 0
    print "Test 4A: FAILED\n"
  
  if myFloatEQ(Q.CPT[True], .8780):
    print "Test 4B: OK\n"
  else:
    test4 = 0
  ...
  test5 = 1
  if myFloatEQ(Q.CPT[False], 0):
    print "Test 5A: OK\n"
  else:
    test5 = 0
    print "Test 5A: FAILED\n"
  
  if myFloatEQ(Q.CPT[True], 1):
    print "Test 5B: OK\n"
  else:
    test5 = 0
